...
// キーボードリスナーを登録する。
{
    var addKeyboardListener = function addKeyboardListener(options) {
        $(document).keydown(function (event) {
            var keyboard = options[util.RESET_KEYBOARD_KEY];
